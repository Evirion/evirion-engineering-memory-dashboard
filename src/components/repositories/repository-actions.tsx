...
import { ExpiresPicker } from "@/components/repositories/expires-picker"
...
export type ActionContext = {
  ...
  readonly repositoryReturnPath?: string
}

const repositoryPath = (
  repositoryId: string,
  repositoryReturnPath: string | undefined,
): string => repositoryReturnPath ?? `/repositories/${repositoryId}`
...
export const ActivateForm = ({
  ...
  !controls.canActivate ? null : (
    <GatedForm
      ...
      returnPath={repositoryPath(repository.id, repositoryReturnPath)}
      mutationPath="/api/repositories/activate"
...
export const DisableForm = ({
  ...
  !controls.canDisable ? null : (
    <GatedForm
      ...
      gate="repository_policy"
      returnPath={repositoryPath(repository.id, repositoryReturnPath)}
      mutationPath="/api/repositories/disable"
      className="flex flex-col gap-3 rounded-2xl border border-border bg-card px-5 py-4 shadow-panel"
    >
      ...
      <ReauthenticationPreconditionNotice testId="repository-disable-reauth-notice" />
...
export const RequestChangeForm = ({
  ...
  !controls.canRequestChange || candidates.length === 0 ? null : (
    <GatedForm
      ...
      gate="repository_policy"
      returnPath={repositoryPath(repository.id, repositoryReturnPath)}
      mutationPath="/api/repositories/request-change"
      className="flex flex-col gap-3 rounded-2xl border border-border bg-card px-5 py-4 shadow-panel"
    >
      <h2 className="text-sm font-semibold text-foreground">
      ...
      <ReauthenticationPreconditionNotice testId="repository-change-reauth-notice" />
...
export const PolicyForm = ({
  ...
  !controls.canChangePolicy ? null : (
    <GatedForm
      ...
      gate="repository_policy"
      returnPath={repositoryPath(repository.id, repositoryReturnPath)}
      mutationPath="/api/repositories/policy"
      className="flex flex-col gap-3 rounded-2xl border border-border bg-card px-5 py-4 shadow-panel"
    >
      ...
      <ReauthenticationPreconditionNotice testId="repository-policy-reauth-notice" />
      ...
      >
        ...
        <fieldset className="flex flex-col gap-2">
          ...
          {choices.map((choice) => (
            ...
            >
              <Checkbox
                id={`profile-${choice.canonicalIdentifier}`}
        ...
        <ExpiresPicker defaultValue={repository.effectiveConsent?.expiresAt} />
        <ReauthenticationPreconditionNotice testId="repository-consent-reauth-notice" />
