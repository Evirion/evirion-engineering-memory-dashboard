...
export const ConsoleBar = ({
  ...
  <header className="border-border bg-glass inset-shadow-glass sticky top-0 z-20 border-b backdrop-blur-xl">
    {/* Shares the measure the console layout sets, so the bar tracks the
        width of whatever the page below it turned out to need. */}
    <div className="mx-auto flex w-full max-w-(--console-measure) flex-wrap items-center gap-x-4 gap-y-2 px-4 py-2.5 sm:px-6 lg:px-10">
