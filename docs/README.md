...
- [Recorded release evidence](contracts/console-contract-v1.0.2-evidence.json)
- [Pinned release bytes](../vendor/console-contract-v1.0.2/console-contract-v1.0.2.tar.gz)
