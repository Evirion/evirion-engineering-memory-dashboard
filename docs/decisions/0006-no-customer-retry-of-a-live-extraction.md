...
detail and processing-row identifiers are published in `console-contract-v1.0.5`
...
- The contract publishes exactly two retry or resume operations, and both are
  ...
  [`openapi.yaml`](../../vendor/console-contract-v1.0.5/contracts/console/v1/openapi.yaml)
...
- `recoveryAction` exists only on
  [`repository-import.json`](../../vendor/console-contract-v1.0.5/contracts/console/v1/schemas/repository-import.json)
  and
  [`repository-import-failures.json`](../../vendor/console-contract-v1.0.5/contracts/console/v1/schemas/repository-import-failures.json).
